...
class CSN(NeuralNetwork):
    def __init__(self, word_embeddings, args, logger=None):
        ...
        # self.word_embedding = nn.Embedding(num_embeddings=len(word_embeddings), embedding_dim=200, padding_idx=0, _weight=torch.FloatTensor(word_embeddings))
        ...
        self.affine2 = nn.Linear(in_features=4 * 3 * 64, out_features=args.gru_hidden)
